...
DELETE FROM pol_vfront 
WHERE party_name IN (SELECT  pol_vfront.party_name 
FROM pol_vfront,form_c_pessoas_rejeitado
WHERE public.pol_vfront.party_name = public.form_c_pessoas_rejeitado.party_name);

DELETE FROM pol_vfront 
WHERE party_name IN (SELECT pol_vfront.party_name 
FROM pol_vfront,
form_b_pessoas
WHERE public.pol_vfront.party_name = public.form_b_pessoas.party_name);
