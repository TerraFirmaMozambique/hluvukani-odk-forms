...
(
	...
	COPY public.update_form_c_pontos FROM '/var/lib/share/projects/illovo/working_folder/Hluvukani_C_pontos.csv'  USING DELIMITERS ',' WITH NULL AS '' CSV HEADER;
...
INSERT INTO public.form_c_pontos (parentuid, geom, latitude, longitude, altitude, accuracy, upngpslimit, key)
SELECT parentuid, geom, latitude, longitude, altitude, accuracy, upngpslimit, key
